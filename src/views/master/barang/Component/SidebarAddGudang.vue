<template>
  <b-sidebar id="sidebar-add-gudang" sidebar-class="sidebar-lg" bg-variant="white" shadow backdrop no-header right>
    <template #default="{ hide }">
      ...
      <b-form class="p-2" @submit.prevent>
        <!-- Customer Name -->
        <b-form-group label="Nama Gudang" label-for="nama-gudang">
          <b-form-input id="nama-gudang" v-model="nama_gudang" trim placeholder="Nama Gudang" />
        </b-form-group>

        <b-form-group label="Alamat Gudang" label-for="alamat-gudang">
          <b-form-input id="alamat-gudang" v-model="alamat_gudang" trim placeholder="Alamat Gudang" />
        </b-form-group>
        <!-- Form Actions -->
