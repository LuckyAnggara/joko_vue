            ...
            <b-row>
              <b-col cols="12">
                <b-form-group label="Tahun Anggaran" label-cols-md="3">
                  <v-select v-model="form.tahun" placeholder="Tahun Anggaran" label="nama" :options="mainStore.tahunOptions" @input="changeTahun()"></v-select>
                </b-form-group>
              </b-col>
              <b-col cols="12">
...
export default {
  ...
  methods: {
    ...
    loadMak() {
      this.makStore.getData(this.form.tahun)
