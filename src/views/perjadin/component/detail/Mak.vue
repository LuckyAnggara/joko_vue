      ...
      <b-card title="Mata Anggaran Kegiatan" footer-tag="footer">
        <b-card-body>
          <b-row>
            ...
            <b-col cols="12">
              <b-form-group label="Saldo DIPA" label-cols-md="3" label-cols-sm="12">
                <b-form-input :value="formatRupiah(form.mak.dipa)" placeholder="-" readonly />
              </b-form-group>
            </b-col>
            ...
            <b-col cols="12">
              <b-form-group label="Saldo Unrealisasi" label-cols-md="3" label-cols-sm="12">
